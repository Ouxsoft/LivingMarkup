...
// this only produces html
// the image request handles the image resize and caching

class Img extends \Pxp\Element
{
	const IMAGE_DIR = '/assets/images/';
	const IMAGE_CACHE_DIR = '/cache/type/images/';
	
	public $offset = ['x' => 0,'y' => 0];
	public $alt = ''; // decorative
	public $author = 'Unknown';
	public $width = 100;
	public $height = 100;
	public $source = 'blank.jpg'; // original file source
